  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <button
          onClick={fetchData}
          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#18181B] text-white text-sm font-medium hover:bg-[#27272A]"
          data-testid="login-audit-refresh"
        >
      ...
      {/* Filters */}
      <div className="bg-white rounded-2xl border border-[#E4E4E7] p-3 flex flex-wrap items-center gap-2">
        <Funnel size={16} className="text-[#71717A] ml-1" />
        <select value={filters.role} onChange={(e) => setFilters({ ...filters, role: e.target.value })}
          className="px-3 py-1.5 border border-[#E4E4E7] rounded-lg text-sm bg-white">
